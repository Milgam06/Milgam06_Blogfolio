 ...
 */
export const HighlightSection: React.FC<HighlightSectionProps> = ({ title, content, filesUrl, isFirst }) => {
  ...
  return (
    <>
      <SectionLayout fullScreen={true}>
        {!loading ? (
          <S.HighlightSectionContainer backgroundColor={basicColor} isFirst={isFirst}>
            <S.HighlightSectionContentContainer {...fadeInScroll({ delay: 0.06 })}>
